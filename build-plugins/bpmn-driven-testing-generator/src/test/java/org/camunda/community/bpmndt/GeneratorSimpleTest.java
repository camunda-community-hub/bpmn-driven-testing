...
public class GeneratorSimpleTest {
	...
	public void testSimpleAsync() {
		...
		containsCode(typeSpec.methodSpecs.get(1)).contains("instance.apply(startEventAfter);")
	...
	public void testSimpleSubProcess() {
		...
		containsCode(typeSpec.methodSpecs.get(1)).contains("// startEvent: subProcessStartEvent")
