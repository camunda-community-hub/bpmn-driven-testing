...
public class GeneratorTest {
	...
	/**
	 * Should generate the first test case and skip the second. Since the second
	 * test case has the same name as the first, which is not allowed.
	 */
	@Test
	...
	public void testIncomplete() {
		...
		containsCode(typeSpec.methodSpecs.get(0))
				.contains("throw new java.lang.RuntimeException(\"Path is incomplete\");");
	...
	public void testInvalid() {
		...
		containsCode(typeSpec.methodSpecs.get(0))
				.contains("throw new java.lang.RuntimeException(\"Path is invalid\");");
