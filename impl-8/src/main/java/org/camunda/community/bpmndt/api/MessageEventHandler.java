...
public class MessageEventHandler {
  ...
  /**
   * Creates a new handler that by default correlates a message.
   *
   * @param elementId ID of the BPMN message event.
   */
   ...
   *
   * @param elementId  ID of the BPMN message event.
   * @param attachedTo ID of the BPMN element, the message event is attached to.
   */
  public MessageEventHandler(String elementId, String attachedTo) {
    if (elementId == null) {
  ...
  void apply(TestCaseInstance instance, long flowScopeKey) {
    ...
    var messageSubscription = instance.getMessageSubscription(flowScopeKey, element.id, element.attachedTo);
