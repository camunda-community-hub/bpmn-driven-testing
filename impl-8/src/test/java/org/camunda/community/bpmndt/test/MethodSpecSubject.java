...
public class MethodSpecSubject extends Subject {
  ...
  MethodSpecSubject(FailureMetadata metadata, MethodSpec actual) {
  ...
  public void hasParameters(String... parameterNames) {
    ...
    var actualParameterNames = actual.parameters.stream().map(parameter -> parameter.name).toArray(String[]::new);
