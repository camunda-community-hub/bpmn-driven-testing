...
public interface TestCases {
  ...
  /**
   * Reads test cases from the given input stream. A runtime exception is thrown, when the BPMN model
   * could not be parsed.
   * 
   ...
   */
  public static TestCases of(InputStream stream) {
   ...
   * @return The test cases.
   */
  public static TestCases of(BpmnModelInstance modelInstance) {
    return TestCasesImpl.of(modelInstance);
  }

  /**
   * Reads test cases from the BPMN file with the given path. A runtime exception is thrown, when the
   * file could not be found or read or the BPMN model could not be parsed.
   * 
   * @param bpmnFile A readable BPMN file.
   * 
   * @return The test cases.
   */
  public static TestCases of(Path bpmnFile) {
   ...
   * 
   * @return The test cases of the process or an empty list, if the process has no test cases or does
   *         not exist.
   */
