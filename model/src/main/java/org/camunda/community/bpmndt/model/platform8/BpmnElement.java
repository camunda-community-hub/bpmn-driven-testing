...
public interface BpmnElement {
  ...
  /**
   * Determines if the BPMN element is a parallel multi instance.
   *
   * @return {@code true}, if the element is a parallel multi instance. Otherwise {@code false}.
  ...
  /**
   * Returns {@code true}, if the BPMN element is an end element of the process.
   *
   * @return {@code true}, if the element ends the process. Otherwise {@code false}.
   */
