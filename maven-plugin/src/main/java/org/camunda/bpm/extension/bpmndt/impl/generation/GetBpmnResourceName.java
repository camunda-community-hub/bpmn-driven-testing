...
public class GetBpmnResourceName implements BiFunction<GeneratorContext, TestCase, MethodSpec> {

  @Override
  public MethodSpec apply(GeneratorContext context, TestCase testCase) {
    return MethodSpec.methodBuilder(GeneratorConstants.GET_BPMN_RESOURCE_NAME)
        .addAnnotation(Override.class)
        .addModifiers(Modifier.PROTECTED)
        .returns(String.class)
        .addStatement("return $S", context.getBpmnResourceName())
        .build();
  }
}
