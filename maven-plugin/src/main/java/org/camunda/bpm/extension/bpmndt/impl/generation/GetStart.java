...
public class GetStart implements BiFunction<GeneratorContext, TestCase, MethodSpec> {

  @Override
  public MethodSpec apply(GeneratorContext context, TestCase testCase) {
    return MethodSpec.methodBuilder(GeneratorConstants.GET_START)
        .addAnnotation(Override.class)
        .addModifiers(Modifier.PROTECTED)
        .returns(String.class)
        .addStatement("return $S", testCase.getPath().getStart())
        .build();
  }
}
