...
public class UserTaskMessageTest {
  ...
  private class TestCase extends AbstractJUnit4TestCase {
    ...
    protected void execute(ProcessInstance pi) {
      ...
      piAssert.hasPassed("userTask", "messageBoundaryEvent", "endEvent").isEnded();
    }

    @Override
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Paths.get("./src/test/it/advanced/src/main/resources/userTaskMessage.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
