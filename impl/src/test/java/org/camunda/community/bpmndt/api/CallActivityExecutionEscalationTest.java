...
public class CallActivityExecutionEscalationTest {
  ...
  private static class TestCase1 extends AbstractJUnit5TestCase<TestCase1> {
    ...
    protected void execute(ProcessInstance pi) {
      ...
      piAssert.hasPassed("callActivity", "escalationBoundaryEvent", "escalationEndEvent").isEnded();
    }
  ...
  private static class TestCase2 extends AbstractJUnit5TestCase<TestCase1> {
    ...
    protected void execute(ProcessInstance pi) {
      ...
      piAssert.hasPassed("fork", "escalationEndEvent").isEnded();
    }
