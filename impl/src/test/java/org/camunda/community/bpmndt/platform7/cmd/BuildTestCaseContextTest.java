...
public class BuildTestCaseContextTest {
  ...
  public void testBuild() {
    ctx = of(Platform7TestPaths.simple("special/happyPath.bpmn"));
  ...
  public void testBuildMultiInstanceScopeInner() {
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeInner.bpmn"), 0);
    ...
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeInner.bpmn"), 1);
    ...
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeInner.bpmn"), 2);
    assertThat(ctx.getTestCase().getActivities()).hasSize(3);
    assertThat(ctx.getTestCase().getActivities().get(0).getId()).isEqualTo("subProcessStartEvent");
    assertThat(ctx.getTestCase().getActivities().get(1).getId()).isEqualTo("subProcessEndEvent");
  ...
  public void testBuildMultiInstanceScopeNested() {
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeNested.bpmn"), 0);
    ...
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeNested.bpmn"), 1);
    ...
    ctx = of(Platform7TestPaths.advancedMultiInstance("scopeNested.bpmn"), 2);
