...
public class SendTaskTest {
  ...
  public void setUp() {
    ...
    element.setId("sendTask");
    element.setType("sendTaskType");
  ...
  public void testExecute() {
    JobWorkerBuilderStep3 workerBuilder = client.newWorker().jobType("sendTaskType").handler((client, job) ->
  ...
  private class TestCase extends AbstractJUnit5TestCase {
    ...
    protected void execute(TestCaseInstance instance, ProcessInstanceEvent processInstanceEvent) {
      ...
      instance.isWaitingAt(processInstanceEvent, "sendTask");
      instance.apply(processInstanceEvent, handler);
      instance.hasPassed(processInstanceEvent, "sendTask");
    ...
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Platform8TestPaths.simple("simpleSendTask.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
