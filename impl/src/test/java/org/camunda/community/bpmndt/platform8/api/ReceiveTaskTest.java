...
public class ReceiveTaskTest {
  ...
  private class TestCase extends AbstractJUnit5TestCase {
    ...
    protected void execute(TestCaseInstance instance, ProcessInstanceEvent processInstanceEvent) {
      ...
      instance.isWaitingAt(processInstanceEvent, "receiveTask");
      instance.apply(processInstanceEvent, handler);
      instance.hasPassed(processInstanceEvent, "receiveTask");
    ...
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Platform8TestPaths.simple("simpleReceiveTask.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
