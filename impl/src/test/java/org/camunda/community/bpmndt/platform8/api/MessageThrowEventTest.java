...
public class MessageThrowEventTest {
  ...
  public void setUp() {
    ...
    element.setId("messageThrowEvent");
    element.setType("messageThrowEventType");
  ...
  public void testExecute() {
    JobWorkerBuilderStep3 workerBuilder = client.newWorker().jobType("messageThrowEventType").handler((client, job) ->
  ...
  private class TestCase extends AbstractJUnit5TestCase {
    ...
    protected void execute(TestCaseInstance instance, ProcessInstanceEvent processInstanceEvent) {
      ...
      instance.isWaitingAt(processInstanceEvent, "messageThrowEvent");
      instance.apply(processInstanceEvent, handler);
      instance.hasPassed(processInstanceEvent, "messageThrowEvent");
    ...
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Platform8TestPaths.simple("simpleMessageThrowEvent.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
