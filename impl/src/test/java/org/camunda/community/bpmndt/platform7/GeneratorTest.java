...
public class GeneratorTest {
  ...
  public void setUp(TestInfo testInfo) {
    ...
    ctx.setMainResourcePath(Platform7TestPaths.simple().resolve("special"));
  ...
  public void testGenerate() {
    ...
    // API classes
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/AbstractJUnit5TestCase.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/AbstractTestCase.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/CallActivityDefinition.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/CallActivityHandler.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/EventHandler.java")).isTrue();
  ...
  public void testGenerateSpringEnabled() {
    ...
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/cfg/BpmndtParseListener.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/cfg/BpmndtProcessEnginePlugin.java")).isTrue();
    assertThat(isFile.test("org/camunda/community/bpmndt/platform7/api/cfg/SpringConfiguration.java")).isTrue();
  }
