...
public class BusinessRuleTaskTest {
  ...
  public void setUp() {
    ...
    element.setId("businessRuleTask");
    element.setType("businessRuleTaskType");
  ...
  public void testExecute() {
    JobWorkerBuilderStep3 workerBuilder = client.newWorker().jobType("businessRuleTaskType").handler((client, job) ->
  ...
  private class TestCase extends AbstractJUnit5TestCase {
    ...
    protected void execute(TestCaseInstance instance, ProcessInstanceEvent processInstanceEvent) {
      ...
      instance.isWaitingAt(processInstanceEvent, "businessRuleTask");
      instance.apply(processInstanceEvent, handler);
      instance.hasPassed(processInstanceEvent, "businessRuleTask");
    ...
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Platform8TestPaths.simple("simpleBusinessRuleTask.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
