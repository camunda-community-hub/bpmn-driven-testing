...
public class GeneratorMultiInstanceScopeTest {
  ...
  public void setUp(TestInfo testInfo) {
    ...
    ctx.setMainResourcePath(Platform7TestPaths.advancedMultiInstance());
  ...
  public void testSequential() {
    ...
    assertThat(typeSpec.methodSpecs.get(2)).containsCode(
        "return new org.camunda.community.bpmndt.platform7.api.UserTaskHandler(getProcessEngine(), \"userTask\")");
    ...
    assertThat(typeSpec.methodSpecs.get(6)).isProtected();
    assertThat(typeSpec.methodSpecs.get(6)).containsCode(
        "return new org.camunda.community.bpmndt.platform7.api.JobHandler(getProcessEngine(), \"callActivity\")");
