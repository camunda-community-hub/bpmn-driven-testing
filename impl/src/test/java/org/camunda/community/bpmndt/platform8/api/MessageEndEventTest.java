...
@ZeebeProcessTest
public class MessageEndEventTest {
  ...
  public void setUp() {
    ...
    element.setId("messageEndEvent");
    element.setType("messageEndEventType");
  ...
  public void testExecute() {
    JobWorkerBuilderStep3 workerBuilder = client.newWorker().jobType("messageEndEventType").handler((client, job) ->
  ...
  private class TestCase extends AbstractJUnit5TestCase {
    ...
    protected void execute(TestCaseInstance instance, ProcessInstanceEvent processInstanceEvent) {
      ...
      instance.isWaitingAt(processInstanceEvent, "messageEndEvent");
      instance.apply(processInstanceEvent, handler);
      instance.hasPassed(processInstanceEvent, "messageEndEvent");
    }
    ...
    protected InputStream getBpmnResource() {
      try {
        return Files.newInputStream(Platform8TestPaths.simple("simpleMessageEndEvent.bpmn"));
      } catch (IOException e) {
        return null;
      }
    }
