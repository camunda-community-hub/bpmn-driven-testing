...
public class MultiInstanceHandler<T extends MultiInstanceHandler<?, ?>, U> {
  ...
  /**
   * Applies the multi instance loop for the given index. Please note: This method will be overriden by generated multi instance handler classes in case of call
   * activities, external tasks and user tasks.
   *
