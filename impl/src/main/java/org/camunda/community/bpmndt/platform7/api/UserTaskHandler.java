...
public class UserTaskHandler {
  ...
  /**
   * Completes the user task with an action that calls {@code complete}, when the process instance is waiting at the corresponding activity. Please note: this
  ...
  /**
   * Continues the execution with an action that calls {@code handleBpmnError} using the given error code and message, when the process instance is waiting at
  ...
  /**
   * Continues the execution with an action that calls {@code handleEscalation} using the given escalation code, when the process instance is waiting at the
   ...
   *
   * @param verifier Verifier that accepts an {@link ProcessInstanceAssert} and an {@link TaskAssert} instance.
   * @return The handler.
   */
  ...
  /**
   * Sets a variable, which is passed to the execution when a predefined behavior ({@code complete}, {@code handleBpmnError}, or {@code handleEscalation}) is
   * used.
   *
  ...
  /**
   * Sets variables, which are passed to the execution when a predefined behavior ({@code complete}, {@code handleBpmnError}, or {@code handleEscalation}) is
   * used.
   *
  ...
  /**
   * Sets a typed variable, which is passed to the execution when a predefined behavior ({@code complete}, {@code handleBpmnError}, or {@code handleEscalation})
   * is used.
   *
   * @param name  The name of the variable.
