...
import static org.camunda.community.bpmndt.platform7.api.TestCaseInstance.PROCESS_ENGINE_NAME;
...
public abstract class AbstractTestCase<T extends AbstractTestCase<?>> {
  ...
  /**
   * Performs the tear down for a test case execution. This method must be invoked after each test!
   */
  protected void afterEach() {
    Mocks.reset();

    if (instance == null) {
      // skip, if process engine was not built
