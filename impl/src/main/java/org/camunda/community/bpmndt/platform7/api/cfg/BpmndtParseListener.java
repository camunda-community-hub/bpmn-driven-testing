package org.camunda.community.bpmndt.platform7.api.cfg;
...
/**
 * Custom BPMN parse listener that instruments activities and overrides {@link CallActivityBehavior}s to make test cases independent of sub processes.
 */
