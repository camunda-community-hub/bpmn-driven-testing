...
public interface GeneratorStrategy {
  ...
  /**
   * Returns code for getting an after handler field reference. Normally an after handler field is
   * references using {@link TestCaseActivity#getLiteral()} + {@code After}, but in case of a multi
   * instance scope a specific {@code getHandler} method must be called.<br>
   * <br>
   * 
   * Normally:
   * 
  ...
  /**
   * Returns code for getting a before handler field reference. Normally a before handler field is
   * references using {@link TestCaseActivity#getLiteral()} + {@code Before}, but in case of a multi
   * instance scope a specific {@code getHandler} method must be called.<br>
   * <br>
   * 
   * Normally:
